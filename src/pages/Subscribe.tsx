...
export function Subscribe(){
    ...
    return(
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center md:pl-6 md:pr-6">
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col gap-2 w-full">
                        <input
                            ...
                            //Vou pegar o evento de digitação, do input que é o target, e o que eu vou pegar será o valor do input de fato
                        />
                        <input
                            className="bg-gray-900 rounded px-5 h-14" 
                            type="email" 
                        ...
                        {loading ? 
                            <button 
                                className="flex items-center justify-center mt-4 bg-green-500 uppercase py-4 rounded font-bold text-sm hover:bg-green-700 transition-colors disabled:opacity-70 "
                                type="submit"
                                disabled={loading}
                            >
